...
class BarretRelocateRLEnv(LabRelocateEnv, BaseRLEnv):
    def __init__(self, use_gui=False, frame_skip=10, robot_name="barret_hand_iiwa14",
        ...
        if "barret" not in robot_name or "free" in robot_name:
        ...
        finger_tip_names = ["finger_1_tip", "finger_2_tip", "finger_3_tip"]
        finger_contact_link_name = [
            "base_link", "finger_3_med_link", "finger_3_dist_link", "finger_3_tip",
            "finger_1_prox_link", "finger_1_med_link", "finger_1_dist_link", "finger_1_tip",
            "finger_2_prox_link", "finger_2_med_link", "finger_2_dist_link", "finger_2_tip",
        ]
...
def main_env():
    ...
    env = BarretRelocateRLEnv(use_gui=True, robot_name="barret_hand_iiwa14",
    ...
    for i in range(1000):
        ...
        action = np.zeros(env.action_dim) * 2 - 1
        action[2] = 0.1
