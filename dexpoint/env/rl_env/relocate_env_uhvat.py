...
class FreeUhvatRelocateRLEnv(LabRelocateEnv, BaseRLEnv):
    def __init__(self, use_gui=False, frame_skip=10, robot_name="uhvat_prl_free",
        ...
        if "uhvat" not in robot_name or "free" not in robot_name:
...
def main_env():
    ...
    env = FreeUhvatRelocateRLEnv(use_gui=True,
