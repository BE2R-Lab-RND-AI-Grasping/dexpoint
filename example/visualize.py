...
if __name__ == '__main__':
    ...
    def create_env_fn():
        ...
        # object_category="02876657"
        env_params = dict(robot_name="uhvat_hand_iiwa14",object_name=object_name, rotation_reward_weight=rotation_reward_weight,
    ...
    checkpoint_path='assets/checkpoints/20250122-1228/model_350.zip'
    ...
    while True:
        ...
        for j in range(env.horizon):
            ...
            returned_iter += reward
            env.render()
            if done:
                break
        sum_returned += returned_iter
        print(num_iter, returned_iter, sum_returned/num_iter)
